	...
	public void handleIncomingPacket(int i1, int j1) throws IOException{
		if(i1 == 255){
			for(int k1 = 0; k1 < 18; k1++){
				bb[k1] = super.connectionStream.b(super.ab, 1 + k1 * 2);
			}
			
			bd = super.connectionStream.b(super.ab, 37);
			hd = true;
			return;
		}
		if(i1 == 254){
		...
		if(i1 == 252){
			f = super.connectionStream.b(super.ab, 1);
			j = super.connectionStream.b(super.ab, 3);
			ab = super.connectionStream.b(super.ab, 5);
			ic = super.connectionStream.b(super.ab, 7);
			hc = super.connectionStream.b(super.ab, 9);
			if(f != kc){
				vb = 5;
				n = 17;
				l = 40;
